...
/// <summary>
/// ive used the base structure of the old charactercontroller from crownfall but its updated and isnt that buggy anymore
/// </summary>
public class FirstPersonController : MonoBehaviour
{
    ...
    private void HandleMovement()
    {
        ...
        {
            //in air: mix the direction with the new input
    ...
    private void GroundCheck()
    {
        ...
        if (Physics.SphereCast(sphereOrigin, sphereRadius, Vector3.down, out RaycastHit hitInfo, groundCheckDistance, groundMask))
        {
            ...
            groundNormal = hitInfo.normal; // save the floor normals
